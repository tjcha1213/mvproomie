...
const INQUIRY_AVATARS = [avatarAt(9), avatarAt(10), avatarAt(11), avatarAt(12), avatarAt(13)];
const PAYMENT_AVATARS = [avatarAt(14), avatarAt(15), avatarAt(16), avatarAt(17), avatarAt(18)];
